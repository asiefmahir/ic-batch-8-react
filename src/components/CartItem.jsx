...
import { modifyQuantityOfAnItem, removeFromCart } from "../store/action/cart";
import { icons } from "../assets";
							...
							onClick={() => {
								if (itemQuantity > 1) {
									this.setState((prevState) => ({
										...prevState,
										itemQuantity:
											prevState.itemQuantity - 1,
									}));
									this.props.modifyQuantityOfAnItem({
										id: item.id,
										quantity: itemQuantity - 1,
									});
								} else {
									alert(
										`The quantity cannot be lesser than 1`,
									);
								}
							}}
						>
...
export default connect(null, { removeFromCart, modifyQuantityOfAnItem })(
	CartItem,
);
